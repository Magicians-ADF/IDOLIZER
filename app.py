    ...
    if (cv_txt == "") and (job_post_txt == ""):
        ...
        if label == 0:
            ...
            DATA_ANALYST_SKILL_SET = ["dashboard", "data models", "build models", "deploy models", "modeling",
                                      "statistics", "Periscope", "Tableau",
                                      "Looker", "Snowflake", "SQL", "reporting", "Tracking KPI’s", "forecast",
                                      "Power Bl", "Excel", "SAP",
                                       "Google sheets", "MySQL", "R", "python", "SQL", "Sql",
                                      "Python", "visualizing",
                                      ...
                                      "Qualtrics", "Alchemer", "Survey Monkey",
                                      "Develop data models", "Quicksight",
                                      ...
                                      "BigQuery", "Adobe Analytics",
                                      "NoSQL", "DataOps",
                                      "Oracle", "MATLAB", "data mining", "segmentation",
                                      "Oracle BI", "MS Office", "Amazon Web Services",
                                      "LTV", "CLTV", "A/B or multivariate testing",
                                      "Airflow", "AWS Glue", "AWS",
                                      "GCP", "Databricks",
                                      "Google analytics",
            ...
            DATA_SCIENCE_SKILL_SET = ["SQL", "Python", "PostgreSQL", "Redshift", "Python",
                                      ...
                                      "DataRobot", "KubeFlow", "Elixir", "Go", "Bash",
                                      "CI/CD", "TDD",
                                      "TensorFlow", "PyTorch",
            ...
            DATA_ENGINEER_SKILL_SET = ["SQL", "Spark", "Hadoop", "Hive", "Presto", "Python", "Java", "C ++", "Scala",
                                       "Shell Script", "ETL", "ELT", "GCP", "Google Cloud Platform", "RDBMS", "AWS",
